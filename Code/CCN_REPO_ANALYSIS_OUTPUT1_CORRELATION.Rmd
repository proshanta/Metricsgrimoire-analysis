...
directory<-"../Output/CCN_REPO_ANALYSIS_OUTPUT1/"
resultdirectory<-"../Output/CCN_REPO_ANALYSIS_OUTPUT1/Result/"
resultCordirectory<-"../Output/CCN_REPO_ANALYSIS_OUTPUT1/ResultCor/"
resultRegdirectory<-"../Output/CCN_REPO_ANALYSIS_OUTPUT1/ResultReg/"
...
for(row in 1:length(filenames)){
    ...
    no_of_bug_owned<-file$no_of_bug_owned
    avg_resolution<-file$avg_resolution
    ...
    resultFrame<-cbind(no_of_bug_owned=no_of_bug_owned,avg_resolution=avg_resolution,scmChanges=scmChanges,scrChanges=scrChanges,mslChanges=mslChanges,number_of_domain=number_of_domain,country=country,linesadded=linesadded,linesremoved=linesremoved,ReviewGotMerged=ReviewGotMerged,X=X,in_degree=in_degree,out_degree=out_degree,degree=degree,betweenness=betweenness,clustcoeff=clustcoeff,closeness=closeness,eigencentrality=eigencentrality,resultFrame)
